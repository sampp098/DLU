...
// ==============================================================
#ifndef __DLU_mac_muladd_8sbkb__HH__
#define __DLU_mac_muladd_8sbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(DLU_mac_muladd_8sbkb) {
    ...
    SC_CTOR(DLU_mac_muladd_8sbkb):  simcore_mac_0_U ("simcore_mac_0_U") {
